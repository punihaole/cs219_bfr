...
int test_grid()
{
    ...
    printf("cluster(2) = %d\n", grid_cluster(2, x, y));
    double d = -1;
    grid_distance(2, 0, x, y, &d);
    printf("distance(2,0) = %5.5f\n", d);
    grid_distance(2, 1, x, y, &d);
    printf("distance(2,1) = %5.5f\n", d);
    grid_distance(2, 2, x, y, &d);
    printf("distance(2,2) = %5.5f\n", d);
    grid_distance(2, 3, x, y, &d);
    printf("distance(2,3) = %5.5f\n", d);
    grid_distance(2, 4, x, y, &d);
    printf("distance(2,4) = %5.5f\n", d);
    grid_distance(2, 5, x, y, &d);
    printf("distance(2,5) = %5.5f\n", d);
    grid_distance(2, 6, x, y, &d);
    printf("distance(2,6) = %5.5f\n", d);
    grid_distance(2, 7, x, y, &d);
    printf("distance(2,7) = %5.5f\n", d);
    grid_distance(2, 8, x, y, &d);
    printf("distance(2,8) = %5.5f\n", d);
    grid_distance(2, 9, x, y, &d);
    printf("distance(2,9) = %5.5f\n", d);
    grid_distance(2, 10, x, y, &d);
    printf("distance(2,10) = %5.5f\n", d);
    grid_distance(2, 11, x, y, &d);
    printf("distance(2,11) = %5.5f\n", d);
    grid_distance(2, 12, x, y, &d);
    printf("distance(2,12) = %5.5f\n", d);
    grid_distance(2, 13, x, y, &d);
    printf("distance(2,13) = %5.5f\n", d);
    grid_distance(2, 14, x, y, &d);
